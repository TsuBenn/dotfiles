...
ColumnLayout {
        ...
        ColumnLayout {
            ...
            Repeater {
                ...
                delegate: Cells {
                    ...
                    property bool expanded: list.expanded.includes(modelData.app)
                    ...
                    function expand() {
                        expanded = true
                        if (!list.expanded.includes(modelData.app)) {
                            list.expanded.push(modelData.app)
                        }
                    }
                    ...
                    function collapse() {
                        expanded = false
                        if (list.expanded.includes(modelData.app)) {
                            list.expanded.filter(n => n != modelData.app)
                        }
                    }
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    CellText {
                                        ...
                                        font: Cell.fontB
                                        preferedW: list.contentW - 7 - 5*icon.success
                                        color: {
    ...
    RowLayout {
        ...
        CellButton {
            ...
            onReleased: (button) => {
                if (button == "L") {
                    if (list.expanded.length > 0) list.collapse()
                    if (list.expanded.length == 0) list.collapse()
                }
            }
